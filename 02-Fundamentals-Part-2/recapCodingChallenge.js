...
//     console.log(`It's a draw baby!`)
// } else {
//     console.log(`There's no winner for the trophy`)
// };
...
//creating the bills array
const bills = [125, 555, 44];

//creating the tips array
const tips = [calcTip(bills[0]), calcTip(bills[1]), calcTip(bills[2])];


//creating the total array - bill + tip
...
if (mark["bmi"] > john["bmi"]) {
    ...
    console.log(`${john["fullname"]}'s BMI (${john["calcBMI"]}) is higher than ${mark["fullname"]}'s BMI (${mark["bmi"]})`);
};
